...
var stackDriverLogger = &Logger{nil, global.ServiceName, ""}
...
func Initialize(ctx context.Context) {
	...
	stackDriverLogger = &Logger{
		stackDriverClient.Logger("rf-api"),
		global.ServiceName,
		"",
	}
}
...
func NewLogger(requestID string) (*Logger, error) {
	...
	if stackDriverClient != nil {
		logger = stackDriverClient.Logger("rf-api")
	}

	// Create and return new logger instance.
	return &Logger{logger, requestID, ""}, nil
}

// Critical logs a message of critical severity.
func Critical(format string, args ...interface{}) {
	logWithLineNumber(stackDriverLogger, logLevelCritical, format, args...)
}
...
func Error(format string, args ...interface{}) {
	logWithLineNumber(stackDriverLogger, logLevelError, format, args...)
}
...
func Warn(format string, args ...interface{}) {
	log(stackDriverLogger, logLevelWarn, format, args...)
}
...
func Info(format string, args ...interface{}) {
	log(stackDriverLogger, logLevelInfo, format, args...)
}
...
func Debug(format string, args ...interface{}) {
	log(stackDriverLogger, logLevelDebug, format, args...)
}
...
func log(logger *Logger, level uint, format string, args ...interface{}) {
	...
	if stackDriverClient != nil && logger != nil {
